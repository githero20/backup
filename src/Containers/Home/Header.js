      ...
      <div className="row pt-lg-1">
        <div className="col-lg-6 mt-md-5 mt-lg-0 text-center text-lg-left">
          <div className="header-words-container pt-lg-5 pr-lg-3">
            <h1
              className={`animated fadeInDown delay-1s fast 
            ...
            {text ? (
              <p
                className={`header-sub-title animated 
            ...
            {button && (
              <Fragment>
                ...
                <div
                  className="hero-cta-btn-container pt-3 mb-3
              ...
              ? slides.map((slide, i) => {
                  return (
                    <img
                      src={slide.img}
                      key={i}
                      className="item hero-slide-item"
