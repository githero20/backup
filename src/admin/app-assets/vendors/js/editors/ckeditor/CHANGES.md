...
* [#14620](https://dev.ckeditor.com/ticket/14620): Fixed: BankCardSetting both the `min-height` style for the `<body>` element and the `height` style for the `<html>` element breaks the [Auto Grow](http://ckeditor.com/addon/autogrow) plugin.
...
* [#5217](http://dev.ckeditor.com/ticket/5217): BankCardSetting data (including switching between modes) creates a new undo snapshot. Besides that:
