                    ...
                    <div className="offset-0 col-md-6 ">
                      ...
                      >
                        <div className="yellow-icon-holder">
                          <img
                            className="mb-2 pt-md-2 yellow-icon"
                            src={yellowIcon}
                            alt="yellow icon"
                          />
                        </div>
                        ...
                        <p className="section-details-paragraph text-center text-md-left mb-md-2  ">
                          Backup Cash is a secure and automated savings app that
                          allows you earn higher interest on deposits than your
                          bank.{" "}
                        </p>
                        <p className="section-details-paragraph text-center text-md-left ">
                          It helps make saving little amounts of money easy, so
                          ...
                          <div className="col-12">
                            <div className="d-flex flex-column flex-md-row justify-content-around align-items-center">
                              ...
                              <div className="ml-md-2 ml-md-0">
                                ...
                                <h6 className="pr-lg-5">
                                  Your funds are invested in the SFS Fixed
                                  Income Fund, managed by SFS Capital. The SFS
                                  Fixed Income Fund is AA rated and has won the
                                  BusinessDay Award for the Best performing
                                  Fixed Income Fund in 2018 and 2019.
                                </h6>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="row ">
                    <div className="col-md-12">
                      <div className="section-header mt-md-5 ">
                        <img
                          className="mb-5 mb-md-3 yellow-icon-2"
                          src={yellowIcon}
                          alt=""
                        />
                    ...
                    <div className="row mx-lg-5">
                      <div className="col-md-4 px-md-1">
                        <div className="card-container text-center mb-xs-5">
                          <div className="pt-5 mb-5  mb-md-3 pt-md-3">
                            <button className="rounded-btn round-btn-dark-blue">
                              1
                            </button>
                          </div>
                          <p className="card-text mb-5">
                            Create an account or login in less than two minutes{" "}
                          </p>
                      ...
                      <div className="col-md-4 px-md-1">
                        <div className="card-container text-center">
                          ...
                          <p className="card-text mb-5">
                            Choose a savings plan that works for you{" "}
                          </p>
                          <div className="card mb-5">
                            <img
                              className="card-1-img mt-3"
                              src={cardIll2}
                              alt="illustration"
                            />
                          </div>
                      ...
                      <div className="col-md-4 px-md-1">
                        <div className="card-container text-center">
                          ...
                          <p className="card-text mb-5">
                            Rest easy and watch your money grow{" "}
                          </p>
                          <div className="card mb-5">
                            <img
                  ...
                  <div className="row mt-0 pt-md-5 mb-md-5">
                    <div className="col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                      <div className="section-header mt-5 mb-5">
                        <img
                          className="mb-4 yellow-icon"
                          src={yellowIcon}
                          alt=""
                        />
                        <p>
                          Reach your savings goal the simple and reliable way
                        </p>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="section-transparent-card reduced-section-transparent-card mb-5 ">
                        ...
                        <div className="section-transparent-card-right text-center text-md-left">
                          ...
                          <p>
                            Earn high interest upfront when you choose the
                            option of saving for a specified period.
                          </p>
                        </div>
                      </div>
                      <div className="section-transparent-card mb-5">
                        ...
                        <div className="section-transparent-card-right text-center text-md-left">
                          ...
                          <p>
                            Automate exactly how you want to save whether its
                    ...
                    <div className="col-md-6">
                      <div className="section-transparent-card mb-5">
                        ...
                        <div className="section-transparent-card-right text-center text-md-left">
                          ...
                          <p>
                            Start making deposits with your atm card or direct
                            debit.
                          </p>
                        </div>
                      </div>
                      <div className="section-transparent-card mb-5">
                        ...
                        <div className="section-transparent-card-right text-center text-md-left">
                          ...
                          <p>
                            Our partner, SFS capital has 30+ years of fund
                  ...
                  <div className="row">
                    <div className="col-12">
                      <p className="text-center gray-text fs-1-5 mt-5 mb-3 mb-lg-5 mt-lg-0 d-flex align-items-lg-center justify-content-lg-center flex-column flex-lg-row">
                        <span>Start Saving with only</span>
                        <span className="d-flex align-items-center justify-content-center">
                          ...
                          <span>or</span>
                          <a
                            href="https://play.google.com/store/apps/details?id=com.sfs.backup_cash"
                            className="deep-blue-link-underline cursor-pointer"
                            rel="noopener noreferrer"
                            target="_blank"
                          >
                    ...
                    <div className="col-md-4 ">
                      <div className="fs-1-8 mt-5 mt-md-2 mt-lg-5 mb-3 text-center">
                        <img
                          className="mb-3 mb-md-1 mb-lg-3"
                          src={require("../../admin/app-assets/images/svg/award-medal.svg")}
                          alt="award medal"
                        />
                        <p className="circular-std-Book text-deep-blue">
                          Some of our{" "}
                        </p>
                        <p className="circular-std-Black text-deep-blue px-3 px-lg-0 mb-5">
                          Acheivements{" "}
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="carousel-inner">
                          <div className="carousel-item">
                            <div className="comment-box">
                              ...
                              <p>
                                At first I was not very sure about Backup Cash
                                story cos this is Nigeria, there are many
                                fraudster with different apps and website. But
                                when I heard about them from IG I was like me
                                give them a call if someone answers me then we
                                can start from there. And that's all I was very
                                convinced cos I asked the person on the other
                                side a lot of questions to my satisfaction. In
                                fact they are amazing even when I visited their
                                office I was like wow... and that increase my
                                trust in them to 98%. You guys are doing awesome
                              </p>
                              <h4>Peter Pounds </h4>
                              <img
                                src={commentIcon}
                          ...
                          <div className="carousel-item active">
                            <div className="comment-box">
                              ...
                              <p>
                                Thanks for the app. I feel so proud to actually
                                be able to start a saving culture. Over time i
                                will save even more.
                              </p>
                          ...
                          <div className="carousel-item">
                            <div className="comment-box">
                              ...
                              <p>
                                I must salute your intelligence and creativity
                                for creating this saving/investment platform,
                                encouraging Nigerians to be habitual savers and
                                investment seekers. Kudos! your platform is
                                superb and I can recommend it to friends and
                                family
                              </p>
                          ...
                          <div className="carousel-item">
                            <div className="comment-box">
                              ...
                              <p>
                                I am so grateful for this kind opportunity.
                                Firstly, mybackupcash has help me a lot in terms
                                of maintaining my saving, its make me feel more
                                assured that my money is well keep, and its even
                                provide job for me in terms of referring people,
                                then I have my commission on it, it’s very good
                              </p>
                          ...
                          <div className="carousel-item">
                            <div className="comment-box">
                              ...
                              <p>
                                I was referred to Backup cash by a friend and I
                                haven't stopped since then. Backup Cash has
                                helped me save more than I ever imagined. The
                                fact that I even save with interest is just mind
                                blowing. Now am using the steady safe where I
                                can save without having to be concerned about
                                the transfer process. Automation is great!-{" "}
                              </p>
                          ...
                          <div className="carousel-item">
                            <div className="comment-box">
                              ...
                              <p>
                                Ever since I started using backup cash,I have
                                saved more money than ever.At first I thought i
                                couldn't do it but I did it and it worked
                                perfectly
                              </p>
                              <h4>Mattew Blaze</h4>
                              <img
                  ...
                  <div className="row  pt-sm-0 pt-md-5 text-center mb-5 pb-5">
                    ...
                    <div className="col-12">
                      ...
                      >
                        ...
                        <div className="partner-img-container">
                          <a
                            href={"https://www.sfsnigeria.com/"}
                            rel={"noopenner noreferrer"}
                            target="_blank"
                          >
                            <img
                              className="partner-img-50 sfs-image"
                              src={sfsImage}
                              alt="sfs"
                            />
                          </a>
                        ...
                        <div className="partner-img-container">
                          <a
                            href={"http://www.tm30.net"}
                            rel={"noopenner noreferrer"}
                            target="_blank"
                          >
                            <img
                              className="partner-img-50 tm-30"
                              src={tm30}
                              alt="aa"
                            />
                          </a>
                    ...
                    <div className="col-md-6">
                      <div className="action-placeholder ">
                        <h2 className="mb-3 mt-5 pr-lg-5 text-white cas-title">
                          Protect your interest with SFS Backup Cash
                        </h2>
                        <Link
                          to={"/sign-up"}
                        ...
                        <div className="btn btn-whatsapp social-media">
                          <div className="footer-icon-list d-flex justify-content-between">
                            <span className="fa-stack fa-sm">
                              <a
                                href="https://www.facebook.com/BackUpCash/"
                                rel="noreferrer"
                                target="_blank"
                              >
                            ...
                            <span className="fa-stack fa-sm">
                              <a
                                href="https://twitter.com/mybackupcash"
                                rel="noreferrer"
                                target="_blank"
                              >
                                <i className="fa fa-circle fa-stack-2x" />
                            ...
                            <span className="fa-stack fa-sm">
                              <a
                                href="https://www.instagram.com/mybackupcash/"
                                rel="noreferrer"
                                target="_blank"
                              >
                                <i className="fa fa-circle fa-stack-2x" />
              ...
              <footer className="home-footer footer">
                <div className="container my-0 my-lg-5">
                  <div className="row px-lg-5 mx-lg-5">
                    ...
                    <div
                      className="col-md-9 offset-md-0 col-sm-12 offset-sm-0
                    ...
                    >
                      <div className="row">
                        ...
                        <div className="col-sm-6 offset-sm-6 offset-md-0 col-md-4 col-lg-4 ">
                          ...
                          <p className="gray-text footer-p">
                            Plot 287 Ajose Adeogun Street, Victoria Island
                            23401, Lagos
                          </p>
                          <div className="gray-text footer-p">
                            Enquires:
                    ...
                    <div className="col-md-12 mt-5 d-flex flex-column flex-md-row justify-content-between">
                      <p className="footer-sub-text text-center">
                        &copy; SFSbackup Cash 2019. All Rights Reserved
                      </p>
                      <p className="footer-sub-text text-center mr-lg-3">
                        Powered by
                        <a
                          href="http://www.tm30.net"
                          rel="noreferrer"
