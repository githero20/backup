        ...
        const showMonth = (
            <div className="col-12 col-lg-6">
                ...
                <label htmlFor="exampleFormControlSelect2">Day of the Month</label>
                    <select value={day_of_month} onChange={this.changeHandler}  id="day_of_month" name={'day_of_month'}>
        ...
        const showDay = (
            <div className="col-12 col-lg-6">
                <div className="form-group">
                    ...
                    <select value={day_of_week} onChange={this.changeHandler} id="day_of_the_week" name="day_of_the_week">
