...
} from '../../../actions/LockedSavingsAction';
...
class TransferLockedSavingsModal extends React.Component {
  constructor(props) {
    ...
    this.handleLockedSavingsInterest = this.handleLockedSavingsInterest.bind(
      this
    );
  }
            ...
            <Form onSubmit={this.validateForm}>
              <Form.Row>
                <Form.Group as={Col} sm={6} controlId='formGridAddress1'>
                  ...
                  <Form.Control
                    ...
                    onChange={(value) =>
                      _handleFormChange('title', value, this)
                    }
                ...
                <Form.Group as={Col} sm={6} controlId='formGridEmail'>
                  ...
                  <Form.Text className='text-muted'>
                    Enter the end Date when funds should be returned to your
                    Backup Stash savings.
                  </Form.Text>
                  {this.validator.message(
                    'end Date',
              ...
              <Form.Row>
                <Form.Group as={Col} sm={6} controlId='formGridCity'>
                  ...
                  <Form.Text className='text-muted'>
                    Enter the amount that will be instantly removed from your
                    Backup Stash balance and locked away.
                  </Form.Text>
                </Form.Group>
                <Form.Group as={Col} sm={6} controlId='formGridCity'>
                  ...
                  <Form.Control
                    ...
                    disabled={true}
                    value={`₦ ${
                      this.state.form.interestRate
                    } @ ${this.state.form.interest.toFixed(2)}% for ${
                      this.state.form.days
                    } days`}
                  />
                  <Form.Text className='text-muted'>
                    This upfront interest will be deposited in your Backup Stash
              ...
              <Form.Row>
                <Form.Group controlId='formBasicChecbox'>
                  <Form.Check
                    ...
                    onChange={(value) =>
                      _handleFormChange('accepted', value, this)
                    }
                    label={
                      <Form.Text>
                        I hereby confirm and approve this transaction, and I
                        authorize SFS BackupCash to LOCK ₦
                        <span>{this.state.form.amount}</span> &nbsp; from my
                        Backup Stash savings immediately and return it in full
                        on the date I set in the "End Date" above. This
                        transaction is IRREVERSIBLE.
                        <br />
                        NB: Funds in "Locked Savings" cannot be accessed until
                        end Date. Locked Funds will be sent back to your Backup
                        Stash on end Date.
                      </Form.Text>
                    }
                  />
