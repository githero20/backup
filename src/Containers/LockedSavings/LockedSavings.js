              ...
              <div className="content-body">
                <div className="row">
                  <div className="col-12 ">
                    ...
                    >
                      <p>
                        Earn your interest upfront, but you need to lock your
                        money with us for a period set by you.
                        <br />
                        You can withdraw at the end of the period you have set.
                      </p>
                    </div>
                  </div>
                  ...
                  <div id="locked-savings" className="col-12 col-md-12">
                    <div className="card">
                      <div className="card-content mt-1 px-2 py-md-3">
                        <div className="table-header d-flex justify-content-between align-items-md-center px-md-2 mb-1">
                          <h4 className="table-title">
                            ...
                            >
                              <img src={lockedSavingIcon} alt="img" />
                              New Locked Savings
                            </button>
                          </h4>
                          <ul className=" mb-0 locked-saving-display d-none d-md-inline-block">
                            <li>
                              {this.state.lockedSavings != undefined
                                ? this.state.lockedSavings.length
                                : 0}{" "}
                              &nbsp; Locked saving
                            </li>
                          </ul>
