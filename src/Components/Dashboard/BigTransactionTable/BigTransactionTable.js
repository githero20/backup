...
class BigTransactionTable extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div id="recent-transaction" className="col-sm-12 col-md-12 col-lg-12 order-md-1">
                    <div className="card">
...
export default BigTransactionTable;